...
public final class APrintExprStatement extends PStatement
{
    ...
    public Object clone()
    {
        return new APrintExprStatement(
    ...
    {
        ((Analysis) sw).caseAPrintExprStatement(this);
    }
