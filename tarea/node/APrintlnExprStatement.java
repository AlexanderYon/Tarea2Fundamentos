...
public final class APrintlnExprStatement extends PStatement
{
    ...
    public Object clone()
    {
        return new APrintlnExprStatement(
    ...
    {
        ((Analysis) sw).caseAPrintlnExprStatement(this);
    }
