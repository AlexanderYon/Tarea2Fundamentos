...
public final class APrintStringStatement extends PStatement
{
    ...
    public Object clone()
    {
        return new APrintStringStatement(
    ...
    {
        ((Analysis) sw).caseAPrintStringStatement(this);
    }
