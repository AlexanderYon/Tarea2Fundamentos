...
public final class AStringInitialization extends PInitialization
{
    private TVar _var_;
    private TEquals _equals_;
    private TStringLiteral _stringLiteral_;

    public AStringInitialization()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStringInitialization(
    ...
    {
        ((Analysis) sw).caseAStringInitialization(this);
    }
