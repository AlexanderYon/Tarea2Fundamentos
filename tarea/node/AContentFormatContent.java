...
public final class AContentFormatContent extends PContent
{
    ...
    public Object clone()
    {
        return new AContentFormatContent(
    ...
    {
        ((Analysis) sw).caseAContentFormatContent(this);
    }
